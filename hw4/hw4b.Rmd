...
box_content[3] = "Exclude patients not involved in motor vehicle accidents \n n = 5,081" # 3rd box
...
ggsave("outcome.png", plot = outcome)
```
...
ggsave("bv_conts.png", plot = bv_conts)
```
...
ggsave("bv_disc.png", plot = bv_disc)
```
