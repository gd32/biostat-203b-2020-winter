...
summary(model1)
#RMSE
sqrt(c(crossprod(model1$residuals))/length(model1$residuals))
```
...
summary(model2)
#RMSE
sqrt(c(crossprod(model2$residuals))/length(model2$residuals))
```
