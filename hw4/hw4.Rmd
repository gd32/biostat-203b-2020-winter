...
# Causes of Mortality in Trauma Surgical Intensive Care Unit (TSICU) Patients 

In my previous assignment (HW2), I noted that there was a noticeable spike in the age distribution of TSICU patients between the ages of 19-25. The TSICU serves patients with severe traumatic injury, respiratory failure as a consequence of major trauma, systemic organ failure, and critical illness post-surgery. (citation: https://www.ccm.pitt.edu/content/upmc-presbyterian-surgical-trauma-icu)  In this analysis, I will further explore possible associations between specific injury types and mortality, focusing on injury categories such as head/brain injuries, liver/spleen/kidney injuries, and blunt force trauma if possible.

Mortality will be the primary outcome variable for the analysis. There is potential to explore alternative outcomes such as length of ICU stay and survival time (i.e. time between admission and death if applicable).
...
Using the tables `patients`, `icustays`, `d_icd_diagnoses` we create a cohort of only TSICU admits. Most likely, we will have to exclude some diagnoses.
