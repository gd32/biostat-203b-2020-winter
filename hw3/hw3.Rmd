...
Find the last day of data collection:

```{r}
covid %>% arrange(date) %>% tail()
```

It appears that the data is being updated daily. We can plot the cumulative number of cases as follows:
